        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-8 text-left">
            <h1 className="cpl-title text-4xl sm:text-6xl lg:text-7xl xl:text-8xl text-[var(--cpl-dark)] leading-[1.05]">
              {t("heroTitle1")}
              <br />
              <span className="text-[var(--cpl-sage)]">{t("heroTitle2")}</span>
              <br />
              {t("heroTitle3")}
            </h1>
            ...
            >
              ...
              >
                ...
                <div className="flex justify-between items-center border-b-2 border-[#1E1E1E] pb-3 mb-4 pr-12">
                  <span className="font-sans font-semibold text-xs sm:text-sm tracking-wider">
                    Clean Plate Lab
                  </span>
                  <Badge
                    variant="solid"
                    className="px-2 py-0.5 text-[10px] sm:text-xs font-sans font-semibold uppercase tracking-widest bg-[#8D9B7D] text-white"
                  >
                    MEAL PREP
                  </Badge>
                </div>
                ...
                <div className="flex items-center justify-between pt-1">
                  ...
                  <div className="w-20 sm:w-24">
                    ...
                    <div className="text-[8px] text-center font-mono mt-0.5 tracking-widest">
                      CPL-014-2026
                    </div>
                  </div>
                </div>
