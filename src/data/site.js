...
export const deliveryMethods = ['Pickup', 'Grab', 'Gojek', 'Customer-arranged delivery'];
...
export const faqs = [
  ...
  { category: 'Ordering', categoryID: 'Pemesanan', question: 'Can I order two meals per day?', questionID: 'Apakah saya bisa memesan dua porsi per hari?', answer: 'Yes. Select two servings per day in the catering form. Both servings use the same daily menu. Meal 1 is ready at 12:00 and Meal 2 at 18:00.', answerID: 'Bisa. Pilih dua porsi per hari pada formulir katering. Kedua porsi menggunakan menu harian yang sama. Meal 1 siap pukul 12.00 dan Meal 2 pukul 18.00.' },
  ...
  { category: 'Delivery', categoryID: 'Pengiriman', question: 'Can I arrange my own courier?', questionID: 'Bisakah saya mengatur kurir sendiri?', answer: 'Yes. Choose Pickup, Grab, Gojek, or Customer-arranged delivery directly in the catering form.', answerID: 'Bisa. Pilih Pickup, Grab, Gojek, atau Kurir Diatur Pelanggan langsung pada formulir katering.' },
